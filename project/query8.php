...
<?php	
$sql="SELECT R.Name1,R.Type, T.Name
FROM Restaurant R, TouristPlace T, accomodation A
WHERE R.PlaceID = T.PlaceID AND T.AccID = A.AccID
GROUP BY A.AccID;
";
